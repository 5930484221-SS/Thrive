    ...
    return (
      <div className="col-sm-6 col-md-4 col-lg-3 px-4">   
        <div
          ...
          <div className="modal fade" id={`modal${index}`.toLowerCase()} tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-orange" data-toggle="modal" data-target="#rating" data-dismiss="modal" >
                    See more review
                  </button>
                  <button
        ...
        <div className="modal fade" id="rating" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <h5 className="card-title pt-3 pb-3">Rate and Review<br />{topic}</h5>
              </div>
              <div className="modal-body" style={{height:"400px",width:"100%",overflow:"auto"}}>
